...
def train_taco2(output_directory, log_directory, checkpoint_path, warm_start, n_gpus,
    ...
    optimizer = torch.optim.Adam(training_parameters_list, lr=learning_rate, weight_decay=hparams.weight_decay)
    ...
    for epoch in range(epoch_offset, hparams.epochs):
        ...
        for i, batch in enumerate(train_loader):
            ...
            if not is_overflow and rank == 0:
                ...
                logger.log_training(
                    reduced_loss, reduced_val_mel_loss, reduced_val_gate_loss, grad_norm, learning_rate, duration, iteration)
...
if __name__ == '__main__':
    ...
    train_taco2(args.output_directory, args.log_directory, args.checkpoint_path,
